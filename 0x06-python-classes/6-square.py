...
class Square:
    ...
    def my_print(self):
        ...
        if self.__size == 0:
            print()
            return
        for ink in range(self.__position[1]):
            print()
        for jet in range(self.__size):
            print("".join([" " for ink in range(self.__position[0])]), end="")
            print("".join(["#" for jet in range(self.__size)]))
